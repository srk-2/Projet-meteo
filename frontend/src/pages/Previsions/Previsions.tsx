...
const Previsions: React.FC = () => {
  ...
  const openMeteoUrl = `https://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&daily=temperature_2m_max,temperature_2m_min&wind_speed_unit=ms&timezone=GMT`;
